...
const uint8_t ST25TB_TRF7970A_Mode_Initiator_Seq[] = {
    MK_WS(TRF79X0_ISO_CONTROL_REG), TRF79X0_ISO_CONTROL_14443B_106K,
...
const uint8_t ST25TB_TRF7970A_Mode_Target_Seq[] = {
    MK_WS(TRF79X0_ISO_CONTROL_REG), TRF79X0_ISO_NFC_OR_CARD_EMULATION_MODE | TRF79X0_NFC_CARD_EMULATION_MODE | TRF79X0_NFC_BR_106K_OR_CE_14443B,
