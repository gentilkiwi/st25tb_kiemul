...
const uint8_t K14A_TRF7970A_Mode_Initiator_Seq[] = {
    ...
    MK_WS(TRF79X0_RX_SPECIAL_SETTINGS_REG), TRF79X0_RX_SPECIAL_SETTINGS_GAIN_RED_0DB,
    MK_WS(TRF79X0_SPECIAL_FUNC_1_REG), TRF79X0_SPECIAL_FUNC_1_14_ANTICOLL_OFF,
    ...
    MK_WS(TRF79X0_REGULATOR_CONTROL_REG), TRF79X0_REGULATOR_CTRL_VRS_3_0V,
    MK_WS(TRF79X0_FIFO_IRQ_LEVEL), 0x0f,
    MK_WS(TRF79X0_NFC_LOW_DETECTION_LEVEL), 0x00,
    MK_WS(TRF79X0_NFC_TARGET_LEVEL_REG), 0x00,
...
const uint8_t K14A_TRF7970A_Mode_Target_Seq[] = {
    MK_WS(TRF79X0_ISO_CONTROL_REG), TRF79X0_ISO_CONTROL_RX_CRC_N | TRF79X0_ISO_NFC_OR_CARD_EMULATION_MODE | TRF79X0_NFC_CARD_EMULATION_MODE | TRF79X0_NFC_BR_106K_OR_CE_14443A,
    MK_WS(TRF79X0_RX_SPECIAL_SETTINGS_REG), TRF79X0_RX_SPECIAL_SETTINGS_M848 | TRF79X0_RX_SPECIAL_SETTINGS_HBT,
    MK_WS(TRF79X0_SPECIAL_FUNC_1_REG), TRF79X0_SPECIAL_FUNC_1_14_ANTICOLL_OFF,
    MK_WS(TRF79X0_CHIP_STATUS_CTRL_REG), TRF79X0_STATUS_CTRL_RF_ON,
    MK_WS(TRF79X0_MODULATOR_CONTROL_REG), TRF79X0_MOD_CTRL_MOD_OOK_100,
    MK_WS(TRF79X0_REGULATOR_CONTROL_REG), TRF79X0_REGULATOR_CTRL_VRS_3_0V,
...
const TRF7970A_MODE K14A_TRF7970A_Mode_Target = {
    .seq = K14A_TRF7970A_Mode_Target_Seq,
    .cbSec = sizeof(K14A_TRF7970A_Mode_Target_Seq),
    .delay = 2,
};
