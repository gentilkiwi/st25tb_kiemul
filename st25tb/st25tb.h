...
#define ST25TB_TARGET_SMALL_DELAY_US   6
#elif defined(__MSP430FR2476__) || defined(__MSP430FR2475__)
#define ST25TB_TARGET_GLOBAL_DELAY_US  72
#define ST25TB_TARGET_MEDIUM_DELAY_US  18
#define ST25TB_TARGET_SMALL_DELAY_US   8
#else
