...
#endif
const uint8_t MyRefSt_Flash[0x80 + 1 + 2][4] =
{
    ...
    // ...
    { 0xee, 0xdd, 0xcc, 0xbb }, // 0x81
    { 0xaa, 0x33, 0x02, 0xd0 }, // 0x82
    // ...
};

uint8_t ST25TB_CARDS_CurrentCard[0x80 + 1 + 2][4];
...
void ST25TB_CARDS_fromSlot(uint8_t slotNumber) // 524 bytes :')
{
