...
#if defined(SLOTS_ST25TB_SUPPORT_2K) || defined(SLOTS_ST25TB_SUPPORT_4K)
...
#endif
    // ...
    { 0xff, 0xff, 0xff, 0xff }, // SLOTS_ST25TB_INDEX_SYSTEM (0xff)
    // ...
    { 0xff, SLOT_UID_BYTE, SLOT_UID_BYTE, SLOT_UID_BYTE }, // SLOTS_ST25TB_INDEX_UID // Test with libnfc and ACR122U/PN532/PN533 did not like 0x00 at the end (?)
    { SLOT_UID_BYTE, 0x33, 0x02, 0xd0 }, // SLOTS_ST25TB_INDEX_UID_2
