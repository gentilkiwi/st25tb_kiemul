...
#define LP_BP_HEADER_11    GPIO_PORT_P8, GPIO_PIN1 // P8.1 - GPIO(!)
// J3 - TODO
// J4 - TODO
...
#define LP_BP_HEADER_09_SET() P4OUT |= BIT2
#define LP_BP_HEADER_09_CLR() P4OUT &= ~BIT2
#define LP_BP_HEADER_18_VAL() (P2IN & BIT2)
